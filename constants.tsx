...
export const ELECTRONIC_EXAMS_ESSAY: Exam = {
  ...
  thumbnail: '📝',
  questions: [
    { id: 'ee1', type: 'fill-in-the-blank', questionText: { ar: 'ما الفرق بين التقييم والتقويم؟', en: 'E1' }, correctAnswer: 'التقييم بيان قيمة الشيء نوعيا بينما التقويم جمع وتصنيف وتحليل بيانات لإصدار حكم أو قرار' },
    { id: 'ee2', type: 'fill-in-the-blank', questionText: { ar: 'ما هي مكونات التقويم الإلكتروني؟', en: 'E2' }, correctAnswer: 'محرك التقييم وبنك العناصر' },
    { id: 'ee3', type: 'fill-in-the-blank', questionText: { ar: 'ما هي الأساليب الأكثر شيوعًا في التقييم الإلكتروني؟', en: 'E3' }, correctAnswer: 'الاختبارات الإلكترونية الرسمية والقصيرة والتكليفات والبورتفوليو برامج التعلم الخصوصي' },
    { id: 'ee4', type: 'fill-in-the-blank', questionText: { ar: 'ما هي أهم مميزات الاختبارات الإلكترونية؟', en: 'E4' }, correctAnswer: 'سهولة إعداد الأسئلة وتوفير الوقت والجهد ومرونة التطبيق والسرعة والموضوعية' },
    { id: 'ee5', type: 'fill-in-the-blank', questionText: { ar: 'ما هي عيوب الاختبارات الإلكترونية؟', en: 'E5' }, correctAnswer: 'صعوبة الحفاظ على أمن الأسئلة والغش وانتحال الشخصية وتعطل الأجهزة وانقطاع الكهرباء' },
    { id: 'ee6', type: 'fill-in-the-blank', questionText: { ar: 'ما هو تعريف الاختبارات التكيفية؟', en: 'E6' }, correctAnswer: 'هي التي يقدم فيها السؤال للمتعلم بحسب إجابته على السؤال السابق' },
    { id: 'ee7', type: 'fill-in-the-blank', questionText: { ar: 'اذكر مزايا الاختبارات التكيفية؟', en: 'E7' }, correctAnswer: 'تحتاج إلى زمن أقل وأقل تكلفة وتحدد المستوى التحصيلي بدقة أكثر' },
    { id: 'ee8', type: 'fill-in-the-blank', questionText: { ar: 'اذكر أمثلة لبرامج متخصصة في إنشاء الاختبارات الإلكترونية؟', en: 'E8' }, correctAnswer: 'Quizcreator و Quizmaker و Quick test و TC exam و Quizfaber و Hot potatoes' },
    { id: 'ee9', type: 'fill-in-the-blank', questionText: { ar: 'ما هي عناصر بناء الاختبارات الإلكترونية؟', en: 'E9' }, correctAnswer: 'أسئلة الاختبار والوصلات وزمن الاختبار والتأمين والتصحيح والتغذية الراجعة' },
    { id: 'ee10', type: 'fill-in-the-blank', questionText: { ar: 'ما هي العوامل المؤثرة في بنك الاختبارات الإلكترونية؟', en: 'E10' }, correctAnswer: 'الأهداف التربوية وخصائص ومهارات المتعلمين والغرض من الاختبار وأشكال التقويم' }
  ]
};
